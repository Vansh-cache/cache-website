...
export function CEOSection() {
  return (
    <section className="py-20 bg-white" id="FoundersMessage">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          <div>
            <div className="overflow-hidden shadow-2xl scale-1.3 rounded-lg">
              <img
                src="/team/prarthna.jpg"
                alt="prarthana Gupta - Chief Executive Officer"
                className="w-full h-[500px] scale-1.5 object-cover"
                loading="lazy"
              />
            </div>
          </div>
