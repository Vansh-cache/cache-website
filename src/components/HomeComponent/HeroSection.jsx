...
const HeroSection = () => {
            ...
            >
                ...
                >
                    ...
                    <img 
                        ...
                        alt="Underline" 
                        className="absolute -mt-1 md:-mt-3 w-40 -translate-x-1/2 left-1/2 top-full z-0 sm:w-56 md:w-72 lg:w-96"
                    />
                </motion.div>
    ...
    <h1 className="font-glacial leading-snug text-black text-3xl md:text-4xl lg:text-5xl" style={{
        ...
        Excellence with Agility,
        <span className="block sm:inline"> Service with Heart</span>
    </h1>
</motion.div>
