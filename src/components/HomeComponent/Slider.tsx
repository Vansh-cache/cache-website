  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-gray-900 py-6">
      ...
      <button
        ...
        className="hidden md:block absolute left-18 top-1/2 transform -translate-y-1/2 z-20 bg-black text-white p-3 rounded-full hover:bg-gray-900/90 transition-all duration-300 ease-out hover:scale-110 shadow-lg backdrop-blur-sm"
      >
      ...
      <button
        ...
        className="hidden md:block absolute right-18 top-1/2 transform -translate-y-1/2 z-20 bg-black text-white p-3 rounded-full hover:bg-gray-900/90 transition-all duration-300 ease-out hover:scale-110 shadow-lg backdrop-blur-sm"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
          {extendedSlides.map((slide, index) => (
            <div
              ...
              className={`flex-shrink-0 w-60 h-86 relative transition-all duration-1000 ease-out
