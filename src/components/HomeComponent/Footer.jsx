  ...
  return (
    <div className="bg-black text-white px-6 sm:px-8 py-12 sm:py-16 font-sans relative">
      ...
      <div className="max-w-7xl mx-auto relative md:ml-14">
        ...
        {/* Logo + Social Section */}
        <div className="mb-10 sm:mb-12 flex flex-col sm:flex-row justify-between items-center sm:items-center gap-6 sm:gap-0">
  {/* Logo - Left on mobile, same on desktop */}
  ...
  <div className="flex flex-col items-center sm:flex-row sm:items-center sm:space-x-4 space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-4">
              {[
                ...
                {
                  d: "M19 0h-14C2.24 0 0 2.24 0 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5zM7.09 20.45H3.73V9h3.36v11.45zM5.41 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zM20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29z",
