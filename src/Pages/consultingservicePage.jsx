...
import { FileCheck, Shield, Bot, TrendingUp, FileText, Users, Building2, Heart, Radio, Factory, ShoppingCart, Sparkles, BarChart3 } from "lucide-react";
...
export default function CompliancePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="hero"
        className="relative h-screen overflow-hidden pt-20 bg-center bg-cover"
      ...
      {/* Centered content */}
      <div className="relative z-10 max-w-5xl mx-auto px-6 h-full flex items-center justify-center text-center">
        <div className="space-y-6 lg:space-y-8">
          {/* Badge */}
          {/* <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/20 border border-red-600/30 rounded-full text-red-200 text-sm font-medium justify-center">
          ...
          <p className="mt-3 sm:mt-4 text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <button
                    key={item.id}
                    onClick={() => scrollToSection(item.id)}
                    className={`px-3 py-1.5 rounded-full border text-xs font-medium whitespace-nowrap ${
                      isActive
      ...
      <section id="overview" className="py-16 lg:py-20 px-6 bg-white">
      ...
      <section id="capabilities" className="py-16 lg:py-24 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
      ...
      <section id="approach" className="py-16 lg:py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
      ...
      <section id="industries" className="py-16 lg:py-24 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 lg:mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/10 border border-red-600/20 rounded-full text-red-600 text-sm font-medium mb-6">
      ...
      <section id="advantage" className="py-16 lg:py-24 px-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        {/* Background Pattern */}
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <div className="pt-6 lg:pt-8 border-t border-gray-700">
                  <p className="text-xl lg:text-2xl font-bold text-red-400 leading-relaxed">
