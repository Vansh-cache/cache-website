    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="hero" className="relative h-screen">
        <div
          ...
          style={{ backgroundImage: "url('/images/cyberimg.webp')" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto h-full flex flex-col items-center justify-center px-6 pt-24 text-center">
          ...
          <p className="mt-4 text-lg sm:text-xl lg:text-2xl text-white/90 max-w-3xl">
      ...
      <section id="specialized" className="py-16 lg:py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Content Side */}
            <div className="space-y-6 lg:space-y-8">
      ...
      <section id="value" className="py-16 lg:py-24 px-6 bg-gradient-to-br from-red-50/50 via-white to-red-50/30">
      ...
      <section id="framework" className="py-16 lg:py-24 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 lg:mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-600/10 border border-red-600/20 rounded-full text-red-600 text-sm font-medium mb-6">
      ...
      {/* Why Partner Section */}
      <section id="partnership" className="py-16 lg:py-24 px-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        {/* Background Pattern */}
